python do_patch:append() {
    ...
    if 'rauc_select=' not in text1:
        insert_block = [
            ...
            '\t"rauc_try_B=if test ${BOOT_B_LEFT} -gt 0; then setexpr BOOT_B_LEFT ${BOOT_B_LEFT} - 1; setenv distro_bootpart ${rauc_slot_b_part}; setenv rauc_slot B; saveenv; run rauc_boot; fi\\0" \\\n',
